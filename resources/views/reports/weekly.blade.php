...
<head>
    <meta charset="UTF-8">
    <title>Laporan Mingguan - {{ $period_label }}</title>
    <style>
...
<body>
    <div class="header">
        ...
        <div class="subtitle">Laporan Keuangan Mingguan</div>
        <div class="date-badge">{{ $period_label }}</div>
    </div>
    ...
    <div class="content">
        ...
        <div class="summary-box">
            ...
            <div class="summary-row">
                <div class="summary-cell-label">&nbsp;&nbsp;&nbsp;↳ Pembelian Stok</div>
            ...
            <div class="summary-row">
                <div class="summary-cell-label" style="font-size:13px; font-weight:800;">LABA / RUGI MINGGU INI</div>
        ...
        <div class="section">
            <div class="section-title">Rekap Harian (Senin — Minggu)</div>
            <table class="data">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    @php $dayProfit = $day['income'] - $day['expense']; @endphp
                    <tr>
                        <td class="font-bold">{{ $day['day'] }}</td>
                        <td class="text-right text-green font-bold">Rp {{ number_format($day['income'], 0, ',', '.') }}</td>
                        <td class="text-right text-red">Rp {{ number_format($day['expense'], 0, ',', '.') }}</td>
                        <td class="text-right font-bold {{ $dayProfit >= 0 ? 'text-green' : 'text-red' }}">
                            {{ $dayProfit >= 0 ? '' : '-' }}Rp {{ number_format(abs($dayProfit), 0, ',', '.') }}
                        </td>
                    </tr>
                    @endforeach
                </tbody>
        ...
        <div class="section">
            <div class="section-title">Piutang Minggu Ini</div>
            <table class="data">
                <thead>
                    <tr>
                        <th>#</th>
        ...
        @if($payables->count() > 0)
        <div class="section">
            <div class="section-title">Utang Minggu Ini</div>
            <table class="data">
                <thead>
                    <tr>
                        <th>#</th>
